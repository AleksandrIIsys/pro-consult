...
import { deleteCareers, deleteTestimonial } from "../../http/Api";
import { Button, Table } from "react-bootstrap";
import { PencilFill, Trash } from "react-bootstrap-icons";
import ModalWindow from "../AdminCareers/ModalWindow";

const CareersTable = observer(

    ({ columns, language, setIsLoad }) => {
        const { careers } = useContext(Context);
