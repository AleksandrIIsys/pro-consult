...
export const messages = {
    ...
    [LOCALES.RUSSIAN]: {
        about_title: `Pro consult company`,
        about_text: `Pro consult company - это многопрофильная консалтинговая компания в области инжиниринга, управления и развития
                        , которая предоставляет проверенные и индивидуальные решения для клиентов и партнеров.
                        Используя обширный опыт и практику своих экспертов, PCC предоставляет консультационные и
                        инженерные услуги на протяжении всего жизненного цикла проекта: инициирование, технико-экономическое обоснование и исследования,
                        проектирование,
                        закупки, строительство, ввод в эксплуатацию, эксплуатация и техническое обслуживание.
                         PCC уделяет приоритетное внимание качеству, эффективности и инновационности, объединяет национальные знания с
